// Jenkins Pipeline - swift-6.0-debian-11
pipeline {
   agent { label 'arm64' }
   ...
   environment {
        ...
        SWIFT_SCHEME = 'release/6.0'
        SWIFT_VERSION = '6.0-DEVELOPMENT-SNAPSHOT'
        DOCKER_IMAGE = 'swiftarm/ci-build:debian_bullseye_swift'
        CONTAINER = 'swift-6.0-dev-debian-11'
        OS = 'debian'
        OS_VERSION = 'bulleye'
        ARCH = 'aarch64'
